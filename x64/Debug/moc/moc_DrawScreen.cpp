...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DrawScreen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DrawScreen_t qt_meta_stringdata_DrawScreen = {
    {
QT_MOC_LITERAL(0, 0, 10) // "DrawScreen"
...
QT_INIT_METAOBJECT const QMetaObject DrawScreen::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_DrawScreen.data,
...
void *DrawScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::DrawScreen"))
        return static_cast< Ui::DrawScreen*>(this);
